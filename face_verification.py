...
import sys
#import sklearn
from check_individual import face_verify
...
configFile = "deploy.prototext.txt"
    ...
    for i in range(faces3.shape[2]):
        ...
        if(True_count/False_count>6):
            ...
            if(face_verify()):
                ...
                print("Verification not successsful")
        if(False_count>100):
            print("Spoofing......")
            warning_msg("This face is not Real.try again")
            True_count=1
            False_count=1
            #cap.release()
            #cv2.destroyAllWindows()
